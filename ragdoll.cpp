...
// bool isClipping(position_var*pos){
//     return true;
// }
...
//         double w; //100 is the speed koeficient of some sort; beta - alfa ensures that the angle is appropriate, but speeds vary
        
            //which direction to move the angle to
//         if(2*pi - beta + alfa < beta - alfa){
//             w = (2*pi-beta + alfa)/100;
//             beta +=w;
//         }
//         else{
//             w = (beta - alfa)/100;
